...
public:
    ...
    void setupUi(QMainWindow *MainWindow)
    {
        ...
        testknopf = new QPushButton(centralwidget);
        testknopf->setObjectName(QString::fromUtf8("testknopf"));
        testknopf->setGeometry(QRect(660, 50, 541, 311));
        testknopf->setFont(font);
